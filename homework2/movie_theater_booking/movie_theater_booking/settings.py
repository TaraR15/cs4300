...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-uw@*dw!#t*)(_5q*k*+x4wi2nkmef)!qc4h#iffjqs3_+8x_g=')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.environ.get('DEBUG', 'False').lower() == 'true'

#ALLOWED_HOSTS = ['localhost', '127.0.0.1', '.devedu.io']
ALLOWED_HOSTS = os.environ.get('ALLOWED_HOSTS', 'localhost,127.0.0.1,.devedu.io').split(',')
...
CSRF_TRUSTED_ORIGINS = [
    'https://app-hw-21.devedu.io',
    'https://*.devedu.io',
]


CSRF_TRUSTED_ORIGINS.append('http://app-hw-21.devedu.io')
